...
**Status**: In Progress (reopened 2026-07-17)
**Priority**: High
...
- [ ] `docs/runbooks/px-proxy.md` simplified for a general audience (reopened 2026-07-17): plain language over jargon, Prerequisites reassures "you probably have everything already", and the WSL-reachability caveat is dropped because this repo's wsl-manager (`Invoke-ConfigureWsl`) already sets `networkingMode=mirrored`

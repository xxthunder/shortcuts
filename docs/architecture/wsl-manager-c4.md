...
C4Container
    ...
    System_Boundary(wslManagerSystem, "WSL Manager System") {
        ...
        Container(tuiLayer, "TUI Layer (manager.ps1)", "PowerShell + PwshSpectreConsole", "Interactive menu with arrow-key navigation, rich tables, and confirmation dialogs; SC-016 modernization complete: menu, table, distro picker and confirmations")

...
if (Get-InstalledModule -Name Pester -MinimumVersion 5.7.1 -MaximumVersion 5.99 -ErrorAction SilentlyContinue) {
    ...
    Install-Module -Repository PSGallery -Scope CurrentUser -Force -Name Pester -MinimumVersion 5.7.1 -MaximumVersion 5.99 -SkipPublisherCheck
}
if (Get-InstalledModule -Name PSScriptAnalyzer -MinimumVersion 1.24 -ErrorAction SilentlyContinue) {
    ...
    Install-Module -Repository PSGallery -Scope CurrentUser -Force -Name PSScriptAnalyzer -MinimumVersion 1.24 -SkipPublisherCheck
}
